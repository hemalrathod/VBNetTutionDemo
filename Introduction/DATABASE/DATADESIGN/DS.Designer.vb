...
Partial Public Class DS
    ...
    Partial Public Class USERSDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddUSERSRow(ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal EMAIL As String, ByVal MOBILE As String, ByVal BIRTHDATE As Date, ByVal USERNAME As String, ByVal PASSWORD As String) As USERSRow
            Dim rowUSERSRow As USERSRow = CType(Me.NewRow,USERSRow)
            Dim columnValuesArray() As Object = New Object() {FIRSTNAME, LASTNAME, EMAIL, MOBILE, BIRTHDATE, USERNAME, PASSWORD}
    ...
    Partial Public Class USERSTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [USERS] ([FIRSTNAME], [LASTNAME], [EMAIL], [MOBILE], [BIRTHDATE], [US"& _ 
                "ERNAME], [PASSWORD]) VALUES (@FIRSTNAME, @LASTNAME, @EMAIL, @MOBILE, @BIRTHDATE,"& _ 
                " @USERNAME, @PASSWORD);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT FIRSTNAME, LASTNAME, EMAIL, MOBILE, BIRTHDATE, U"& _ 
                "SERNAME, PASSWORD FROM USERS WHERE (USERNAME = @USERNAME)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [USERS] SET [FIRSTNAME] = @FIRSTNAME, [LASTNAME] = @LASTNAME, [EMAIL] = @E"& _ 
                "MAIL, [MOBILE] = @MOBILE, [BIRTHDATE] = @BIRTHDATE, [USERNAME] = @USERNAME, [PAS"& _ 
                "SWORD] = @PASSWORD WHERE (((@IsNull_FIRSTNAME = 1 AND [FIRSTNAME] IS NULL) OR (["& _ 
                ...
                " @Original_PASSWORD)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT FIRSTNAME, LASTNAME, EMAIL, MOBILE, BIRTHDATE, U"& _ 
                "SERNAME, PASSWORD FROM USERS WHERE (USERNAME = @USERNAME)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Introduction.My.MySettings.Default.MiscConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        *"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            USERS"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        *"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            USERS"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE USERNAME=@USERNAME"
            ...
            Me._commandCollection(2).CommandText = "SELECT        *"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            USERS"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE USERNAME=@U AND PASSWORD=@P"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@U", Global.System.Data.SqlDbType.NVarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "USERNAME", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@P", Global.System.Data.SqlDbType.NVarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "PASSWORD", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DS.USERSDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DS.USERSDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DS.USERSDataTable = New DS.USERSDataTable()
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As DS.USERSDataTable, ByVal USERNAME As String) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal USERNAME As String) As DS.USERSDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (USERNAME Is Nothing) Then
                Throw New Global.System.ArgumentNullException("USERNAME")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy1(ByVal dataTable As DS.USERSDataTable, ByVal U As String, ByVal P As String) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            If (U Is Nothing) Then
                Throw New Global.System.ArgumentNullException("U")
            Else
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(U,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetUsersByUsernamePassword(ByVal U As String, ByVal P As String) As DS.USERSDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            If (U Is Nothing) Then
                Throw New Global.System.ArgumentNullException("U")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DS.USERSDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal EMAIL As String, ByVal MOBILE As String, ByVal BIRTHDATE As Global.System.Nullable(Of Date), ByVal USERNAME As String, ByVal PASSWORD As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal EMAIL As String, ByVal MOBILE As String, ByVal BIRTHDATE As Global.System.Nullable(Of Date), ByVal USERNAME As String, ByVal PASSWORD As String, ByVal Original_FIRSTNAME As String, ByVal Original_LASTNAME As String, ByVal Original_EMAIL As String, ByVal Original_MOBILE As String, ByVal Original_BIRTHDATE As Global.System.Nullable(Of Date), ByVal Original_USERNAME As String, ByVal Original_PASSWORD As String) As Integer
            If (FIRSTNAME Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal EMAIL As String, ByVal MOBILE As String, ByVal BIRTHDATE As Global.System.Nullable(Of Date), ByVal PASSWORD As String, ByVal Original_FIRSTNAME As String, ByVal Original_LASTNAME As String, ByVal Original_EMAIL As String, ByVal Original_MOBILE As String, ByVal Original_BIRTHDATE As Global.System.Nullable(Of Date), ByVal Original_USERNAME As String, ByVal Original_PASSWORD As String) As Integer
            Return Me.Update(FIRSTNAME, LASTNAME, EMAIL, MOBILE, BIRTHDATE, Original_USERNAME, PASSWORD, Original_FIRSTNAME, Original_LASTNAME, Original_EMAIL, Original_MOBILE, Original_BIRTHDATE, Original_USERNAME, Original_PASSWORD)
        End Function
    End Class
